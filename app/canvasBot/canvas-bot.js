...
.directive('mxCanvasBot', ['testData', 'canvasData', '$timeout', '$interval', function(testData, canvasData, $timeout, $interval){
	return {
		restrict: 'E',
	  ...
	  link: function(scope,element,attrs){
	  	...
	  	scope.canvasid = attrs.canvasid+"canvasid"
	  	...
	  	console.log(scope.canvasid)
	  	$timeout(function(){
				scope.canvasData.generateCanvasB(scope.canvasid, scope.param1, scope.param2, scope.param3, scope.param4, scope.param5, scope.rep1, scope.rep2, scope.paramAdd1, scope.paramAdd2)
				}, 300)
